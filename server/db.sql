...
--
-- Name: notes; Type: TABLE; Schema: public; Owner: tpl522_13
--
...
ALTER TABLE public.notes OWNER TO tpl522_13;
...
--
-- Data for Name: notes; Type: TABLE DATA; Schema: public; Owner: tpl522_13
--

COPY public.notes (id, notes, user_id) FROM stdin;
1	test	2
\.
...
1	Atlas of Dermatological Conditions in Populations of African Ancestry 	https://www.amazon.com/Dermatological-Conditions-Populations-African-Ancestry-ebook/dp/B098L2CQLF
\.
...
6	https://www.nidirect.gov.uk/sites/default/files/styles/nigov_float_x1/public/images/A-Z_raynauds-3_22012020.jpg?itok=R7vBzFEX	Raynaud's Syndrome	Raynaud's may make your fingertips appear paler if you have dark skin. African Americans may not easily recognize it.
8	https://images.squarespace-cdn.com/content/v1/5ef2664ee62f61085293e858/1605366067242-DZMPDH4U5GQ587UD7G4V/P1030564-180Kaposi%27s+sarcoma.jpg?format=750w	Kaposi Sarcoma	Kaposi's sarcoma is a type of cancer that forms in the lining of blood and lymph vessels
9	https://images.squarespace-cdn.com/content/v1/5ef2664ee62f61085293e858/1611497546838-T4CLJUWQ02Q6U95FVGY5/P1090144-255coated+tongue%2C+medical%2C+scarlet+fever%2C+soft+palate+erythema.jpg?format=750w	Scarlet Fever Tongue	Scarlet fever secondary to group A streptococcus causing white coating on the tongue and erythematous soft palate. 
10	https://images.squarespace-cdn.com/content/v1/5ef2664ee62f61085293e858/1611501425672-FDJK1MN3VJTWO9LYRCTD/P1030256-168medical%2C+nodulo-cystic+acne.jpg?format=500w	Acne	Nodulo-cystic Acne
11	https://images.squarespace-cdn.com/content/v1/5ef2664ee62f61085293e858/1607264703453-HLP4VYSYCY5FXK0POIM6/P1010800-102febrile+illness+resulting+in+skin+sloughing.jpg?format=500w	Skin Sloughing	The skin on the sole of the foot appears very hard and discoloured compared to the rest of the patient's foot. 
\.
...
3	test@yahoo.com	test@yahoo.com	https://s.gravatar.com/avatar/88e478531ab3bc303f1b5da82c2e9bbb?s=480&r=pg&d=https%3A%2F%2Fcdn.auth0.com%2Favatars%2Fte.png	auth0|637bce8bf4edfed30f7f9eaa
4	test12@yahoo.com	test12@yahoo.com	https://s.gravatar.com/avatar/9f74e3d4c896a94d86829e0eb413cdd6?s=480&r=pg&d=https%3A%2F%2Fcdn.auth0.com%2Favatars%2Fte.png	auth0|637bcff8bf1ad2112a2d4930
\.
...
SELECT pg_catalog.setval('public.skin_condition_id_seq', 11, true);
...
--
-- Name: notes favorites_pkey; Type: CONSTRAINT; Schema: public; Owner: tpl522_13
--
...
--
-- Name: notes notes_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: tpl522_13
--

ALTER TABLE ONLY public.notes
    ADD CONSTRAINT notes_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.user_accounts(id);
